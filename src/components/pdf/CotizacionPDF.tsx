...
function makeStyles(primary: string, secondary: string) {
  const p = isHex(primary) ? primary : "#ea580c";
  const s = isHex(secondary) ? secondary : "#1e293b";
  return StyleSheet.create({
    ...
    cotTitle: { fontSize: 10, fontFamily: "Helvetica-Bold", color: s, marginBottom: 4 },
    ...
    totalFinalLabel: { fontFamily: "Helvetica-Bold", fontSize: 11, color: p },
    totalFinalValue: { fontFamily: "Helvetica-Bold", fontSize: 12, color: p },
    condiciones: {
      marginTop: 18,
      padding: 8,
      borderWidth: 1,
...
export function CotizacionPDF({
  ...
  const styles = makeStyles(
    empresa.color_primary || "#ea580c",
    empresa.color_secondary || "#1e293b"
  );
